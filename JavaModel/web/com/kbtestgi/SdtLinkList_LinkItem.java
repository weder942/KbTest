/*
       ...
       Generated on: November 13, 2020 10:55:36.6
...
public final  class SdtLinkList_LinkItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      if ( GXutil.strcmp(sNameSpace, "kbTestGi") != 0 )
      {
         oWriter.writeAttribute("xmlns", "kbTestGi");
      }
   ...
   public com.kbtestgi.SdtLinkList_LinkItem Clone( )
   {
      return (com.kbtestgi.SdtLinkList_LinkItem)(clone()) ;
   }

   public void setStruct( com.kbtestgi.StructSdtLinkList_LinkItem struct )
   {
      setgxTv_SdtLinkList_LinkItem_Caption(struct.getCaption());
      setgxTv_SdtLinkList_LinkItem_Url(struct.getUrl());
   }

   public com.kbtestgi.StructSdtLinkList_LinkItem getStruct( )
   {
      com.kbtestgi.StructSdtLinkList_LinkItem struct = new com.kbtestgi.StructSdtLinkList_LinkItem ();
